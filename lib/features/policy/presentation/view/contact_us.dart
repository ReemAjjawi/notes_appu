...
import '../putpolicyBloc/putpolicy_bloc.dart';
...
class ContactUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => putpolicyBloc(sl()),
  ...
  Widget _buildTextField(TextEditingController desController) {
    return SizedBox(
      width: isPortrait ? screenWidth * 0.88 : screenWidth * 0.6,
      child: TextField(
        maxLines: 4,
          ...
          if (state is InitialStatepolicyput) {
            return AppButton(
              ...
              onPressed: () async {
                ...
                print(policy);
                context.read<putpolicyBloc>().add(
                      putpolicyEvent(pass: policy),
                    );
                // }
              },
